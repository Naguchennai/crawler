...
class PHPCrawlerURLDescriptor
{
   ...
   * @internal
   */
  public function __construct($url_rebuild, $link_raw = null, $linkcode = null, $linktext = null, $refering_url = null/*, $refering_sum = null*/)
  {
    ...
    //if (!empty($refering_sum)) $this->refering_sum = $refering_sum;
  }  
}
?>