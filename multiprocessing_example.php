...
class MyCrawler extends PHPCrawler 
{
  ...
  function handleDocumentInfo($DocInfo) 
  {
    ...
    //$i=0;
    //if(!in_array($DocInfo->referer_url, $this->a)){
        //$this->a[] = $DocInfo->referer_url;
		//echo $id = substr( $DocInfo->referer_url, strrpos( $DocInfo->referer_url, '.' )-1 );
        echo $DocInfo->referer_url;
        echo $lb;
   //}
...
$crawler->setURL("http://test.primerates.com");
...
$crawler->addURLFollowRule("/^http:\/\/test.primerates.com/");
